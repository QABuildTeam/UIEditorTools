...
namespace SimpleAudioSystem.Editor
{
    public partial class SimpleAudioSystemEditor
    {
        ...
        {
            private readonly static string scriptTemplate = @"// This file is automatically generated by Simple Audio System Editor
// Do not edit it!
...
";
            ...
            public static void Generate(string filename, string projectNamespace, AudioClipSettings audioClipSettings, AudioEventSettings audioEventSettings)
            {
                if (!string.IsNullOrEmpty(filename) && audioEventSettings != null)
                {
                    ...
                    {
                        string scriptText = string.Format(scriptTemplate, projectNamespace, string.Join(string.Empty, scriptParts.subscriptions), string.Join(string.Empty, scriptParts.handlers));
