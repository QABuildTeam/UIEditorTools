...
{
    public class ImageSizeAdjustmentUtility : EditorWindow
    {
        [MenuItem("Tools/UI Editor Tools/Image processing/Adjust image sizes", false, 0)]
        private static void ShowWindow()
        {
            EditorWindow.GetWindow(typeof(ImageSizeAdjustmentUtility));
        }
        ...
        private void OnGUI()
        {
            GUILayout.Label("Adjust images to match x4 constraint");
