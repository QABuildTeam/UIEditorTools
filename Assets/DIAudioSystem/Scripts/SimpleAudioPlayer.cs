...
namespace DIAudioSystem
{
    public class SimpleAudioPlayer : IAudioPlayer
    {
        ...
        public SimpleAudioPlayer(SimpleAudioSystem.AudioPlayerSettings settings)
        {
            GameObject root = new GameObject("SimpleAudioPlayer");
            musicPlayer = new BasicMusicPlayer(
                root,
                settings.data.musicPlayersCount,
                settings.data.currentMusicVolumeKey,
                settings.data.defaultMusicVolume,
                settings.data.volumeFadeDuration);
            sfxPlayer = new BasicSFXPlayer(
                root,
                settings.data.sfxPlayersCount,
                settings.data.currentSFXVolumeKey,
                settings.data.defaultSFXVolume);
        }
